...
Public Const ERR_TXT_NO_EXACT_FONDFILE As String = "The exact Fondsliste file was not found: "
...
Public Sub RunReportHelaba()
    ...
    strFondFile = ResolveFondslisteFile(strFolder)
...
ErrHandler:
    ...
    Call ErrorManager.addError( _
        CLASS_NAME, METHOD_NAME, errNumber, errDescription, _
        "strFolder;strMode", strFolder, strMode)
    GoTo ExitPoint
End Function
